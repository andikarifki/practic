    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="bg-white shadow rounded-lg border border-emerald-100 overflow-hidden"
                >
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                ...
                                >
                                    ...
                                    <td
                                        class="px-6 py-4 text-sm font-mono font-bold text-emerald-700 whitespace-nowrap"
                                    >
                                        {{ item.pasien?.no_rm || "-" }}
                                    </td>

                                    <td
                                        class="px-6 py-4 text-sm text-gray-700 font-semibold whitespace-nowrap"
                                    >
                                        <div
                                    ...
                                    <td
                                        class="px-6 py-4 text-sm text-gray-500 italic min-w-[200px]"
                                    >
                                        {{ item.keluhan || "-" }}
                                    </td>
                                    <td
